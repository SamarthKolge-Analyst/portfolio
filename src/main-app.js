...
/* =========================================================
   MOBILE CHAT KEYBOARD / VIEWPORT HANDLER
   ========================================================= */
...
(function setupMobileChatViewport() {
    ...
    /* -----------------------------------------------------
       ...
       Give browser time to open keyboard first.
       Then bring input into visible viewport.
       ----------------------------------------------------- */
    ...
    /* -----------------------------------------------------
       Keep messages at bottom when keyboard opens
       ----------------------------------------------------- */
